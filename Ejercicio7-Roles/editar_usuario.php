...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $departamento = $_POST['departamentoEditar'];
    $tipoCuenta = $_POST['tipoCuenta'];
    $saldo = $_POST['saldo'];

    if (actualizarUsuario($conexion, $idUsuario, $nombre, $carnet, $apellidoPaterno, $apellidoMaterno, $celular, $departamento, $tipoCuenta,$saldo)) {
